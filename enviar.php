...
$email_envio = 'edson.santos@escode.com.br'; // E-mail receptor
$email_pass = 'Eds030194'; // Senha do e-mail

$site_name = 'Es code'; // Nome do Site
$site_url = 'escode.com.br'; // URL do Site
